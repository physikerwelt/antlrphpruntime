<?php
// $ANTLR 3.4 texvc.g 2013-09-25 21:39:05
...
class texvc extends Lexer {
    const T_EOF=-1;
    const T_ABOXCHARS=4;
    const T_ALPHA=5;
    const T_BOXCHARS=6;
    const T_COMMAND=7;
    const T_DELIMITER_UF_LT=8;
    const T_DELIMITER_UF_OP=9;
    const T_LATEX_FUNCTION_NAMES=10;
    const T_LITERAL_ID=11;
    const T_LITERAL_MN=12;
    const T_LITERAL_UF_LT=13;
    const T_LITERAL_UF_OP=14;
    const T_MEDIAWIKI_FUNCTION_NAMES=15;
    const T_SPACE=16;
    ...
    function mWHITESPACE(){
        try {
            $_type = texvc::T_WHITESPACE;
            $_channel = texvc::DEFAULT_TOKEN_CHANNEL;
    	$input = $this->input;
            // texvc.g:
            // texvc.g:
            {
            ...
            do {
                ...
                if ( (($LA6_0 >= $this->getToken('9') && $LA6_0 <= $this->getToken('10'))||$LA6_0==$this->getToken('13')||$LA6_0==$this->getToken('32')) ) {
                    $alt6=1;
                }
    ...
    function mCOMMAND(){
    	...
    	$input = $this->input;
            ...
            do {
                ...
                if ( ($LA7_0==$this->getToken('32')) ) {
                    $LA7_1 = $this->input->LA(2);

                    if ( (($LA7_1 >= $this->getToken('9') && $LA7_1 <= $this->getToken('10'))||$LA7_1==$this->getToken('13')||($LA7_1 >= $this->getToken('32') && $LA7_1 <= $this->getToken('33'))||($LA7_1 >= $this->getToken('39') && $LA7_1 <= $this->getToken('44'))||($LA7_1 >= $this->getToken('46') && $LA7_1 <= $this->getToken('59'))||$LA7_1==$this->getToken('61')||$LA7_1==$this->getToken('63')||($LA7_1 >= $this->getToken('65') && $LA7_1 <= $this->getToken('90'))||($LA7_1 >= $this->getToken('96') && $LA7_1 <= $this->getToken('122'))||($LA7_1 >= $this->getToken('128') && $LA7_1 <= $this->getToken('255'))) ) {
                        $alt7=1;
                    }


                }
                else if ( ($LA7_0==$this->getToken('33')||($LA7_0 >= $this->getToken('39') && $LA7_0 <= $this->getToken('44'))||($LA7_0 >= $this->getToken('46') && $LA7_0 <= $this->getToken('59'))||$LA7_0==$this->getToken('61')||$LA7_0==$this->getToken('63')||($LA7_0 >= $this->getToken('65') && $LA7_0 <= $this->getToken('90'))||($LA7_0 >= $this->getToken('96') && $LA7_0 <= $this->getToken('122'))||($LA7_0 >= $this->getToken('128') && $LA7_0 <= $this->getToken('255'))) ) {
                    $alt7=1;
                }
    ...
    function mTokens(){
        ...
        else if ( ($LA8_0==$this->getToken('92')) ) {
            $alt8=2;
        }
        else {
